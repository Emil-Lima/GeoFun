...
function App() {
  ...
  const addSavedCountry = (id) => {
    ...
    if (profile) {
      const tempProfile = { ...profile, savedCountries: temp };
        ...
        <div>
          <Routes>
              ...
              element={
                profile ? (
                  <AppContainer
                    ...
                    addSavedCountry={addSavedCountry}
            ...
            <Route
              ...
              element={
                profile ? (
                  <SelectCountry profile={profile} onHomeClick={onHomeClick} />
                ) : (
                  <ProfileContainer
                    allProfiles={allProfiles}
                    addProfile={addProfile}
